...
public class Ellipse_graph extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.ellipse_graph, container, false);
...
//        });
        ...
        executeB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (et3.isEmpty() || et3.equals("-") || et3.equals(".")||et3.equals("0")) {
                    editText3.setText("1");
                }
                ...
                //Tìm điểm đầu trục dài.
                float x1 = (float) (-Math.sqrt(p5)-p2)/p1;
                ...
                for (float x = -63; x <= 63; x += 0.002f)
                {
                    if (x>=(float)((-Math.sqrt(p5)-p2)/p1) &&
                        ...
                        float y = (float) ((Math.sqrt(p5 - Math.pow((p1 * x + p2), 2)) - p4) / p3);
                        entries.add(new Entry(x, y));
                        y = (float) ((-Math.sqrt(p5 - Math.pow((p1 * x + p2), 2)) - p4) / p3);
                        entries1.add(new Entry(x, y));
                    }
                }
                //Tìm điểm cuối trục
                float x2 = (float) ((Math.sqrt(p5)-p2)/p1);
                float y2 = (float) (-p4/p3);
                entries.add(new Entry(x2,y2));
                entries1.add(new Entry(x2,y2));
